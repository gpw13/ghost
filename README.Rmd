...
gho_indicators() %>%
  ...
  gho_data()
```
And once we have that data, we can then filter, explore, and analyze the data with our standard R workflow, or even export to Excel or other analytical tools.
